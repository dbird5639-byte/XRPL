...
from config import XRPL_CONFIG
...
class XRPLClient:
    ...
    def _init_client(self):
        ...
        if self.network == "mainnet":
            url = XRPL_CONFIG.mainnet_url
        elif self.network == "testnet":
            url = XRPL_CONFIG.testnet_url
        elif self.network == "devnet":
            url = XRPL_CONFIG.devnet_url
        elif self.network == "amm_devnet":
            url = XRPL_CONFIG.amm_devnet_url
        else:
